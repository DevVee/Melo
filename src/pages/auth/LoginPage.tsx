...
import { useSignIn, useSignInWithGoogle, useSignInWithGitHub } from '@/features/auth/hooks/useSignIn'
...
export default function LoginPage() {
  ...
  return (
    <div className="w-full max-w-md space-y-6">
      ...
      {/* Form */}
      <Form {...form}>
        <form onSubmit={form.handleSubmit((v) => signIn(v))} className="space-y-4">
          <FormField
